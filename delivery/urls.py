...
urlpatterns = [
    ...
    path('produtos/<str:cat>', views.produtos, name="Produtos"),
    ...
    path('vsf/todos',views.produtos_todos,name="Todos os Produtos"),
    ...
    path('user/endereco/add', views.add_endereco, name="Adicionar Endereço"),
]
